var config = {
    ...
    footer: 'Fuentes: Wikipedia - ARCA - GLIMS - NASA',
    chapters: [
        {
            id: 'glaciar1',
            alignment: 'left',
